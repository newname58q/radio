...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data == "replay":
        ...
        buttons = [
            [
                InlineKeyboardButton("🔥 Source Code 🔥", url='https://github.com/newname58q/radio'),
            ],
            [
               InlineKeyboardButton('👥 Group', url='https://t.me/SemtBizimEvKiraa'),
               InlineKeyboardButton('Channel 📢', url='https://t.me/jackmedya'),
            ],
            [
